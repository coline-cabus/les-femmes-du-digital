        ...
        <div class="container mb-5 contenu">
            <div class="row">
                ...
                <div class="col-md-6 text-blog">
                    <h1><?php the_field('titre_blog'); ?></h1>
                    <p><?php the_field('description_blog'); ?></p>
                    <a href="http://localhost:8888/lesfemmesdudigital/design/">Catégorie Design</a>
                    <a href="http://localhost:8888/lesfemmesdudigital/marketing/">Catégorie Marketing</a>
                </div>
            </div>
        </div>
